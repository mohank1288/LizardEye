 ...
 */
package com.lizard.eye.widget.crouton;
...
public class Configuration {
  ...
  public static final Configuration LONG_DURATION;

  static {
    DEFAULT = new Builder().setDuration(DURATION_SHORT).build();
    INFINITE = new Builder().setDuration(DURATION_INFINITE).build();
    LONG_DURATION =  new Builder().setDuration(DURATION_LONG).build();
  }
