...
import com.lizard.eye.adapter.ViewPagerAdapter;
import com.lizard.eye.model.Model;
import com.lizard.eye.ui.abstractactivity.AbstractMainActivity;
import com.lizard.eye.viewpagerindicator.CirclePageIndicator;

public class HelpActivity extends AbstractMainActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		try {
			...
			mActionBar.setTitle(getResources().getString(R.string.help));
			mViewPager = (ViewPager) findViewById(R.id.pager);
			mCirclePageIndicator = (CirclePageIndicator) findViewById(R.id.my_view_circleIndicator);

			flag = new int[] { R.drawable.help1, R.drawable.help2,
					R.drawable.help4 };

			adapter = new ViewPagerAdapter(HelpActivity.this, flag);
